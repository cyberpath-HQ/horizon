...
const mainNavItems: NavItem[] = [
  ...
  { title: "Assets", href: "/assets", icon: FolderKanban },
  { title: "Software", href: "/software", icon: Database },
  { title: "Security", href: "/security", icon: Shield },
  { title: "Network", href: "/network", icon: Network },
  { title: "Vulnerabilities", href: "/vulnerabilities", icon: Shield },
  { title: " BIA", href: "/bia", icon: Workflow },
